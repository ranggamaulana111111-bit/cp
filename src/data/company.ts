export const company = {
	...
	legal: {
		...
		commissioner: 'ILVA KHOIRUNNISA, S.Pd.I.',
		deedEstablishment: 'No. 01 Tanggal 05-10-2018 (Notaris SANDRA TANOD, S.H. / PN Serang Reg. 747/26/cv/18/PIV.Srg)',
	...
	kbliCategories: [
		{
			code: '46511 & 46512',
			title: 'Perdagangan Besar Komputer & Piranti Lunak',
			desc: 'Perdagangan besar komputer, server, perangkat lunak (software), printer, scanner, dan perlengkapan komputer.',
		},
		{
			code: '46521 & 46523',
			title: 'Perdagangan Besar Elektronik & Telekomunikasi',
			desc: 'Perdagangan besar suku cadang elektronik dan peralatan telekomunikasi (router, switch, access point).',
		},
		{
			code: '26210 & 26220',
			title: 'Industri Komputer & Perakitan',
			desc: 'Industri dan perakitan unit komputer, server khusus, serta perlengkapan infrastruktur komputer.',
		},
		{
			code: '43212 & 43213',
			title: 'Instalasi Telekomunikasi & Elektronika',
			desc: 'Pemasangan jaringan Fiber Optic, LAN/Wi-Fi terkelola, instalasi kamera CCTV (IP & Analog), NVR/DVR, dan sistem keamanan gedung.',
		},
		{
			code: '62019 & 62029',
			title: 'Konsultasi & Pemrograman Komputer',
			desc: 'Konsultasi IT, manajemen fasilitas komputer, pemrograman, dan pengembangan solusi teknologi.',
		},
		{
			code: '62024',
			title: 'Konsultasi Internet of Things (IoT)',
			desc: 'Perancangan arsitektur jaringan IoT dan integrasi perangkat pintar untuk otomasi bisnis.',
		},
		{
			code: '63111 & 63122',
			title: 'Pengolahan Data & Portal Digital',
			desc: 'Aktivitas pengolahan data, portal web, dan platform digital komersial.',
		},
		{
			code: '61921 & 61922',
			title: 'Internet Service Provider & Jaringan Data',
			desc: 'Penyediaan layanan internet (ISP), jasa interkoneksi, dan sistem komunikasi data.',
		},
		{
			code: '95110 & 95120',
			title: 'Reparasi Komputer & Peralatan Komunikasi',
			desc: 'Jasa perbaikan komputer, perangkat komunikasi, serta kontrak perawatan berkala.',
		},
		{
			code: '80100 & 80300',
			title: 'Keamanan Swasta & Penyelidikan',
			desc: 'Aktivitas keamanan swasta, pengamanan aset, dan jasa penyelidikan.',
		},
		{
			code: '46900 & 46421',
			title: 'Perdagangan Besar Umum & ATK',
			desc: 'Pengadaan Alat Tulis Kantor (ATK), mesin kantor, perlengkapan umum, dan pengadaan barang/jasa terpadu B2B.',
		},
		{
			code: '82110 & 82190',
			title: 'Jasa Administrasi Kantor & Penunjang',
